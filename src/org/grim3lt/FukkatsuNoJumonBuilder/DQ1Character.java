...
//	};
    ...
    public static DQ1Character build(String name, int exp, int gold, int cryptCode) {
        DQ1Character result = new DQ1Character();

        result.setName(name);
        result.setExp(exp);
        result.setGold(gold);
        result.setCryptCode(cryptCode);
	...
	/**
	 * @param cryptcode cryptcode to set
	 */
	public void setCryptCode(int cryptcode) {
		this.cryptcode = cryptcode & 0x07;
	}
}
