...
public class DQ1FukkatsuNoJumonBuilder {
	 ...
	 * コンストラクタ
	 */
	private DQ1FukkatsuNoJumonBuilder() {
	}

    public static DQ1FukkatsuNoJumonBuilder build(DQ1Character character) {
        DQ1FukkatsuNoJumonBuilder result = new DQ1FukkatsuNoJumonBuilder();
